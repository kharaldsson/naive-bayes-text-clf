...
def run(train_in, test_in, prior_delta, cond_delta, model_file, sys_output):
    ...
    clf = NaiveBayes.Multinomial(train_lines, test_lines, prior_delta, cond_delta)
    clf.fit()
    ...
    fname = 'q3/time_' + str(prior_delta) + '_' + str(cond_delta)
...
if __name__ == "__main__":
    ...
    if TEST:
        ...
        MODEL_FILE = 'q3/model_file'
        SYS_OUTPUT = 'q3/sys_output'
    else:
        TRAIN_IN = sys.argv[1]
        TEST_IN = sys.argv[2]
